...
const Hero = () => {
    return (
        <section id="about" className="min-h-[80vh] md:min-h-screen flex flex-col items-center justify-center relative px-6 pt-20 md:pt-28 pb-10 md:pb-16">
            <motion.div
            ...
            >
                ...
                <div className="relative w-36 h-36 md:w-48 md:h-48 rounded-full p-[2px] bg-gradient-to-tr from-primary to-secondary">
            ...
            >
                <h1 className="text-4xl sm:text-6xl md:text-8xl font-heading font-extrabold mb-4 md:mb-6 tracking-tight leading-[1.3] text-white">
