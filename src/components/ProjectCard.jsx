            ...
            <div className="p-6 flex-grow flex flex-col z-10">
                ...
                <div className="flex items-center gap-4 mt-auto">
                    <a 
                        ...
                        className="font-label text-xs uppercase tracking-wider px-4 py-2 border border-primary/20 rounded-[4px] bg-primary/5 text-primary hover:bg-primary/20 hover:border-primary/40 transition-all flex items-center gap-2 font-medium"
                    >
                    ...
                    {demo && (
                        <a 
                            ...
                            target="_blank" 
                            rel="noopener noreferrer" 
                            className="font-label text-xs uppercase tracking-wider px-4 py-2 border border-secondary/20 rounded-[4px] bg-secondary/5 text-secondary hover:bg-secondary/20 hover:border-secondary/40 transition-all flex items-center gap-2 font-medium"
                        >
