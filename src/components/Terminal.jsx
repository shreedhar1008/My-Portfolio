...
const commands = {
    ...
    skills: "Languages: Python, JavaScript, SQL (MySQL), HTML5, CSS3, Java\nDatabases: MySQL, PostgreSQL, MongoDB, SQLite, Firebase\nAI/ML Frameworks: TensorFlow, Keras, PyTorch, Scikit-learn, OpenCV, NLTK\nGenerative AI & LLMs: LangChain, RAG Pipelines, Google Gemini API, Prompt Engineering\nClassical ML: Random Forest, K-Means Clustering, Decision Trees, Data Augmentation\nDeep Learning & RL: CNNs, LSTMs, Reinforcement Learning, Neural Networks\nData Science: Pandas, NumPy, Matplotlib, Statistical Analysis, Jupyter Notebook\nWeb/Backend: React.js, Flask, REST APIs, Firebase, Vite\nCloud & Tools: GCP, AWS, Git, Docker (Basic), VS Code, Linux\nCS Fundamentals: DSA, DBMS, Operating Systems",
